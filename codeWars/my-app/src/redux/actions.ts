...
export type ChangeCurrencyFieldType = {
    type:  ACTIONS_TYPE.CHANGE_CURRENCY_FIELD_TYPE, payload: { amountOfBYN: string, amountOfCurrency: string }
};
...
export type ChangeAction = {
    type: typeof ACTIONS_TYPE.CHANGE_CHANGE_ACTION, payload: { isBuying: boolean }
};
...
export type ChangeCurrentCurrencyType = {
    type:ACTIONS_TYPE.CHANGE_CURRENT_CURRENCY, payload:{currentCurrency:string}
};
